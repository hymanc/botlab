...
#include "rob550_util.h"

struct rob550_default_implementation {
    vx_world_t *world;
    zhash_t *layers;
...
{
    rob550_default_implementation_t *impl = calloc (1, sizeof(*impl));
    impl->world = world;
    impl->vxeh = vxeh;
...
{
    rob550_default_implementation_t *impl = app->impl;
